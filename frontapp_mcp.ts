      ...
      try {
        ...
        switch (name) {
          ...
          case 'list_conversation_messages':
            ...
            break;
          case 'get_message':
            result = await this.getMessage(args.message_id);
            break;
          case 'send_message':
          ...
          case 'list_contacts':
            ...
            break;
          case 'get_contact':
            result = await this.getContact(args.contact_id);
            break;
          case 'create_contact':
          ...
          case 'list_teammates':
            ...
            break;
          case 'get_teammate':
            result = await this.getTeammate(args.teammate_id);
            break;
          ...
          case 'list_inboxes':
            ...
            break;
          case 'get_inbox':
            result = await this.getInbox(args.inbox_id);
            break;

          // Comment operations
          case 'list_conversation_comments':
            result = await this.listConversationComments(args.conversation_id);
            break;
          case 'add_comment':
          ...
          // Account operations
          case 'list_accounts':
            result = await this.listAccounts(args);
            break;
          case 'create_account':
            result = await this.createAccount(args);
            break;
          case 'get_account':
            result = await this.getAccount(args.account_id);
            break;
          case 'update_account':
            result = await this.updateAccount(args);
            break;
          case 'delete_account':
            result = await this.deleteAccount(args.account_id);
            break;
          case 'list_account_contacts':
            result = await this.listAccountContacts(args);
            break;
          case 'add_contact_to_account':
            result = await this.addContactToAccount(args);
            break;
          case 'remove_contact_from_account':
            result = await this.removeContactFromAccount(args);
            break;

          // Additional Contact operations
          case 'delete_contact':
            result = await this.deleteContact(args.contact_id);
            break;
          case 'merge_contacts':
            result = await this.mergeContacts(args);
            break;
          case 'list_contact_conversations':
            result = await this.listContactConversations(args);
            break;
          case 'list_contact_notes':
            result = await this.listContactNotes(args.contact_id);
            break;
          case 'add_contact_note':
            result = await this.addContactNote(args);
            break;
          case 'add_contact_handle':
            result = await this.addContactHandle(args);
            break;
          case 'delete_contact_handle':
            result = await this.deleteContactHandle(args);
            break;
          case 'list_teammate_contacts':
            result = await this.listTeammateContacts(args);
            break;
          case 'create_teammate_contact':
            result = await this.createTeammateContact(args);
            break;
          case 'list_team_contacts':
            result = await this.listTeamContacts(args);
            break;

          // Channel operations
          case 'list_channels':
            result = await this.listChannels(args);
            break;
          case 'create_channel':
            result = await this.createChannel(args);
            break;
          case 'get_channel':
            result = await this.getChannel(args.channel_id);
            break;
          case 'update_channel':
            result = await this.updateChannel(args);
            break;
          case 'validate_channel':
            result = await this.validateChannel(args.channel_id);
            break;
          case 'list_teammate_channels':
            result = await this.listTeammateChannels(args.teammate_id);
            break;
          case 'list_team_channels':
            result = await this.listTeamChannels(args.team_id);
            break;
          case 'sync_inbound_message':
            result = await this.syncInboundMessage(args);
            break;
          case 'sync_outbound_message':
            result = await this.syncOutboundMessage(args);
            break;
          case 'update_external_message_status':
            result = await this.updateExternalMessageStatus(args);
            break;
          case 'sync_application_message_template':
            result = await this.syncApplicationMessageTemplate(args);
            break;

          // Additional Comment operations
          case 'get_comment':
            result = await this.getComment(args.comment_id);
            break;
          case 'update_comment':
            result = await this.updateComment(args);
            break;
          case 'list_comment_mentions':
            result = await this.listCommentMentions(args.comment_id);
            break;
          case 'add_comment_reply':
            result = await this.addCommentReply(args);
            break;

          // Contact Group operations
          case 'list_contact_groups':
            result = await this.listContactGroups(args);
            break;
          case 'create_contact_group':
            result = await this.createContactGroup(args);
            break;
          case 'delete_contact_group':
            result = await this.deleteContactGroup(args.group_id);
            break;
          case 'list_group_contacts':
            result = await this.listGroupContacts(args.group_id);
            break;
          case 'add_contacts_to_group':
            result = await this.addContactsToGroup(args);
            break;
          case 'remove_contacts_from_group':
            result = await this.removeContactsFromGroup(args);
            break;
          case 'list_teammate_groups':
            result = await this.listTeammateGroups(args.teammate_id);
            break;
          case 'create_teammate_group':
            result = await this.createTeammateGroup(args);
            break;
          case 'list_team_groups':
            result = await this.listTeamGroups(args.team_id);
            break;
          case 'create_team_group':
            result = await this.createTeamGroup(args);
            break;

          // Contact List operations
          case 'list_contact_lists':
            result = await this.listContactLists(args);
            break;
          case 'create_contact_list':
            result = await this.createContactList(args);
            break;
          case 'delete_contact_list':
            result = await this.deleteContactList(args.list_id);
            break;
          case 'list_contact_list_contacts':
            result = await this.listContactListContacts(args);
            break;
          case 'add_contacts_to_list':
            result = await this.addContactsToList(args);
            break;
          case 'remove_contacts_from_list':
            result = await this.removeContactsFromList(args);
            break;
          case 'list_teammate_contact_lists':
            result = await this.listTeammateContactLists(args.teammate_id);
            break;
          case 'create_teammate_contact_list':
            result = await this.createTeammateContactList(args);
            break;
          case 'list_team_contact_lists':
            result = await this.listTeamContactLists(args.team_id);
            break;
          case 'create_team_contact_list':
            result = await this.createTeamContactList(args);
            break;

          // Additional Conversation operations
          case 'create_discussion_conversation':
            result = await this.createDiscussionConversation(args);
            break;
          case 'update_conversation_assignee':
            result = await this.updateConversationAssignee(args);
            break;
          case 'list_conversation_events':
            result = await this.listConversationEvents(args);
            break;
          case 'list_conversation_followers':
            result = await this.listConversationFollowers(args.conversation_id);
            break;
          case 'add_conversation_followers':
            result = await this.addConversationFollowers(args);
            break;
          case 'delete_conversation_followers':
            result = await this.deleteConversationFollowers(args);
            break;
          case 'list_conversation_inboxes':
            result = await this.listConversationInboxes(args.conversation_id);
            break;
          case 'add_conversation_link':
            result = await this.addConversationLink(args);
            break;
          case 'remove_conversation_links':
            result = await this.removeConversationLinks(args);
            break;
          case 'update_conversation_reminders':
            result = await this.updateConversationReminders(args);
            break;
          case 'add_conversation_tag':
            result = await this.addConversationTag(args);
            break;
          case 'remove_conversation_tag':
            result = await this.removeConversationTag(args);
            break;
          ...
          // Draft operations
          case 'create_draft':
            result = await this.createDraft(args);
            break;
          case 'list_conversation_drafts':
            result = await this.listConversationDrafts(args.conversation_id);
            break;
          case 'create_draft_reply':
            result = await this.createDraftReply(args);
            break;
          case 'delete_draft':
            result = await this.deleteDraft(args);
            break;
          case 'edit_draft':
            result = await this.editDraft(args);
            break;

          // Event operations
          case 'list_events':
            result = await this.listEvents(args);
            break;
          case 'get_event':
            result = await this.getEvent(args.event_id);
            break;

          // Additional Inbox operations
          case 'create_inbox':
            result = await this.createInbox(args);
            break;
          case 'list_inbox_channels':
            result = await this.listInboxChannels(args.inbox_id);
            break;
          case 'list_inbox_conversations':
            result = await this.listInboxConversations(args);
            break;
          case 'list_inbox_access':
            result = await this.listInboxAccess(args.inbox_id);
            break;
          case 'add_inbox_access':
            result = await this.addInboxAccess(args);
            break;
          case 'remove_inbox_access':
            result = await this.removeInboxAccess(args);
            break;
          case 'list_team_inboxes':
            result = await this.listTeamInboxes(args.team_id);
            break;
          case 'create_team_inbox':
            result = await this.createTeamInbox(args);
            break;

          // Additional Message operations
          case 'receive_custom_message':
            result = await this.receiveCustomMessage(args);
            break;
          case 'import_message':
            result = await this.importMessage(args);
            break;
          case 'get_message_seen_status':
            result = await this.getMessageSeenStatus(args.message_id);
            break;
          case 'mark_message_seen':
            result = await this.markMessageSeen(args.message_id);
            break;

          // Message Template Folder operations
          case 'list_message_template_folders':
            result = await this.listMessageTemplateFolders(args);
            break;
          case 'create_message_template_folder':
            result = await this.createMessageTemplateFolder(args);
            break;
          case 'get_message_template_folder':
            result = await this.getMessageTemplateFolder(args.folder_id);
            break;
          case 'update_message_template_folder':
            result = await this.updateMessageTemplateFolder(args);
            break;
          case 'delete_message_template_folder':
            result = await this.deleteMessageTemplateFolder(args.folder_id);
            break;
          case 'list_child_folders':
            result = await this.listChildFolders(args.folder_id);
            break;
          case 'create_child_folder':
            result = await this.createChildFolder(args);
            break;
          case 'list_teammate_folders':
            result = await this.listTeammateFolders(args.teammate_id);
            break;
          case 'create_teammate_folder':
            result = await this.createTeammateFolder(args);
            break;
          case 'list_team_folders':
            result = await this.listTeamFolders(args.team_id);
            break;

          // Message Template operations
          case 'list_message_templates':
            result = await this.listMessageTemplates(args);
            break;
          case 'create_message_template':
            result = await this.createMessageTemplate(args);
            break;
          case 'get_message_template':
            result = await this.getMessageTemplate(args.template_id);
            break;
          case 'update_message_template':
            result = await this.updateMessageTemplate(args);
            break;
          case 'delete_message_template':
            result = await this.deleteMessageTemplate(args.template_id);
            break;
          case 'list_child_templates':
            result = await this.listChildTemplates(args.template_id);
            break;
          case 'create_child_template':
            result = await this.createChildTemplate(args);
            break;

          // Additional Tag operations
          case 'get_tag':
            result = await this.getTag(args.tag_id);
            break;
          case 'update_tag':
            result = await this.updateTag(args);
            break;
          case 'delete_tag':
            result = await this.deleteTag(args.tag_id);
            break;
          case 'list_tag_children':
            result = await this.listTagChildren(args.tag_id);
            break;
          case 'create_child_tag':
            result = await this.createChildTag(args);
            break;
          case 'list_tagged_conversations':
            result = await this.listTaggedConversations(args);
            break;
          case 'list_teammate_tags':
            result = await this.listTeammateTags(args.teammate_id);
            break;
          case 'create_teammate_tag':
            result = await this.createTeammateTag(args);
            break;
          case 'list_team_tags':
            result = await this.listTeamTags(args.team_id);
            break;
          case 'create_team_tag':
            result = await this.createTeamTag(args);
            break;

          // Additional Teammate operations
          case 'update_teammate':
            result = await this.updateTeammate(args);
            break;
          case 'list_teammate_conversations':
            result = await this.listTeammateConversations(args);
            break;
          case 'list_teammate_inboxes':
            result = await this.listTeammateInboxes(args.teammate_id);
            break;
